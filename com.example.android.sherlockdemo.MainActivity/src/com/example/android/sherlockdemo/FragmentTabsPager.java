...
public class FragmentTabsPager extends SherlockFragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mTabsAdapter.addTab("simple", "Simple", FragmentStackSupport.CountingFragment.class, null);
		mTabsAdapter.addTab("accounts", "Accounts", AccountListActivity.AccountListFragment.class, null);
		mTabsAdapter.addTab("contacts", "Contacts", LoaderCursorSupport.CursorLoaderListFragment.class, null);
		mTabsAdapter.addTab("custom", "Custom", LoaderCustomSupport.AppListFragment.class, null);
		mTabsAdapter.addTab("throttle", "Throttle", LoaderThrottleSupport.ThrottledLoaderListFragment.class, null);
	}
